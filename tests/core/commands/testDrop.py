...
class dropTests(tests.common.common):
	...
	def test_quantity_too_high_text(self):
		...
		self.rpg.setAction([_('DROP_COMMAND'), 10, 'Heavy breastplate'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_QUANTITY_TOO_HIGH_%s') % 'Heavy breastplate')
	...
	def test_quantity_too_high_json(self):
		...
		self.rpg.setAction([_('DROP_COMMAND'), 10, 'Heavy breastplate'])
		output = self.rpg._runAction(True)
		self.assertEquals(output, {"error": {"message": _('ERROR_DROP_QUANTITY_TOO_HIGH_%s') % 'Heavy breastplate', "code": 1}})

		self.compareInventory(inv)

	# Items tests
	def test_item_missing_text(self):
		self.rpg.setAction([_('DROP_COMMAND')])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_NO_ITEM_GIVEN'))

	def test_item_missing_json(self):
		self.rpg.setAction([_('DROP_COMMAND')])
		output = self.rpg._runAction(True)
		self.assertEquals(output, {"error": {"message": _('ERROR_DROP_NO_ITEM_GIVEN'), "code": 1}})

	def test_item_missing_with_quantity_text(self):
		self.rpg.setAction([_('DROP_COMMAND'), 1])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_NO_ITEM_GIVEN'))
	...
	def test_unknown_item_text(self):
		self.rpg.setAction([_('DROP_COMMAND'), 'some dummy item'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_UNKNOWN_ITEM'))

	def test_unknown_item_json(self):
		self.rpg.setAction([_('DROP_COMMAND'), 'some dummy item'])
		output = self.rpg._runAction(True)
		self.assertEquals(output, {"error": {"message": _('ERROR_DROP_UNKNOWN_ITEM'), "code": 1}})

	def test_not_available_item_text(self):
		self.rpg.setAction([_('DROP_COMMAND'), 'Mist potion'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_ITEM_NOT_AVAILABLE'))

	def test_not_available_item_json(self):
		self.rpg.setAction([_('DROP_COMMAND'), 'Mist potion'])
		output = self.rpg._runAction(True)
		self.assertEquals(output, {"error": {"message": _('ERROR_DROP_ITEM_NOT_AVAILABLE'), "code": 1}})

	# Container tests
	def test_unknown_container_type_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'some container'])
		output = self.rpg._runAction()
	...
	def test_not_available_container_type_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'box'])
		output = self.rpg._runAction()
	...
	def test_missing_container_index_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'wardrobe'])
		output = self.rpg._runAction()
	...
	def test_invalid_container_index_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'wardrobe', 'some index'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('ERROR_DROP_INVALID_CONTAINER_INDEX'))
	...
	def test_invalid_container_index_json(self):
		...
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'wardrobe', 'some index'])
		output = self.rpg._runAction(True)
		self.assertEquals(output, {"error": {"message": _('ERROR_DROP_INVALID_CONTAINER_INDEX'), "code": 1}})
	...
	def test_item_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 1, 'name': 'Heavy breastplate'})
	...
	def test_item_container_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'chest'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 1, 'name': 'Heavy breastplate'})
	...
	def test_item_container_index_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 'Heavy breastplate', 'wardrobe', 1])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 1, 'name': 'Heavy breastplate'})
	...
	def test_quantity_item_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 2, 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 2, 'Heavy breastplate'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 2, 'name': 'Heavy breastplate'})
	...
	def test_quantity_item_container_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 2, 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 2, 'Heavy breastplate', 'chest'])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 2, 'name': 'Heavy breastplate'})
	...
	def test_quantity_item_container_index_text(self):
		self.rpg.setAction([_('TAKE_COMMAND'), 2, 'Heavy breastplate'])
		self.rpg._runAction()
		self.rpg.setAction([_('DROP_COMMAND'), 2, 'Heavy breastplate', 'wardrobe', 1])
		output = self.rpg._runAction()
		self.assertEquals(output, _('DROP_CONFIRMATION_%(quantity)s_%(name)s') % {'quantity': 2, 'name': 'Heavy breastplate'})
